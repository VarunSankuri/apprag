...
with tab2:
    st.markdown('<p class="big-font">Although not necessary,
    If you want to add more context to your questions, you can upload PDF's below for more accurate answers</p>', unsafe_allow_html=True)
